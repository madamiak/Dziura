...
public class OptionView
{
	...
	/**
	 * Przycisk sluzacy do rozpoczecia wysylania zgloszenia na serwer.
	 */
	...
	/**
	 * Tablica zawierajaca nazwy kategorii wyswietlanych na liscie {@link #sDamageType}.
	 */
	...
	public OptionView(DziuraActivity app)
	{
		...
		app.sendUsingServer = app.appConfig.getSendUsingServer();
	...
	private void initDamageTypeList() 
	{
		...
		typesArray = app.appConfig.getDamageTypes();
	...
	private void initMap() {
		...
		mapParams.height = (int)(0.6*(displayHeight - app.tabWidget.getHeight()));
